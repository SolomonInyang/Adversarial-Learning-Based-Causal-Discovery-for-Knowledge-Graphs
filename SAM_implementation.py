...
from loss import notears_constr
from utils_torch import (ChannelBatchNorm1d, MatrixSampler,
        ...
        for i_batch, batch in enumerate(data_iterator):
            ...
            if dagloss and epoch > train * dagstart:
                ...
                loss = gen_loss + regul_loss + (
                            dagpenalization + (epoch - train * dagstart) * dagpenalization_increase) * dag_constraint
            else:
                loss = gen_loss + regul_loss
